                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $obj->email }}</td>
                            <td><a class="btn btn-sm btn-block btn-primary" href="{{ route('empresas.lista_usuarios',['id' => $obj->id]) }}"><i class="fa fa-users"></i></a></td>
                            <td><a class="btn btn-sm btn-block btn-success" href="{{ route('empresas.demonstrativo',['id' => $obj->id]) }}"><i class="fa fa-money"></i></a></td>
